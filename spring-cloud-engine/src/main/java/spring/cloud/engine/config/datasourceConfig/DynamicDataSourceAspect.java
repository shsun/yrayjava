package spring.cloud.engine.config.datasourceConfig;
...
public class DynamicDataSourceAspect {
    ...
    @Before(value = "@within(spring.cloud.engine.config.datasourceConfig.TargetDataSource) || @annotation(spring.cloud.engine.config.datasourceConfig.TargetDataSource)")
    ...
    @After(value = "@within(spring.cloud.engine.config.datasourceConfig.TargetDataSource) || @annotation(spring.cloud.engine.config.datasourceConfig.TargetDataSource)")
