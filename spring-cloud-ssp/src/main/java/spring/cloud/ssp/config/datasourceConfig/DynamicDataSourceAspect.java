package spring.cloud.ssp.config.datasourceConfig;
...
public class DynamicDataSourceAspect {
    ...
    @Before(value = "@within(spring.cloud.ssp.config.datasourceConfig.TargetDataSource) || @annotation(spring.cloud.ssp.config.datasourceConfig.TargetDataSource)")
    ...
    @After(value = "@within(spring.cloud.ssp.config.datasourceConfig.TargetDataSource) || @annotation(spring.cloud.ssp.config.datasourceConfig.TargetDataSource)")
